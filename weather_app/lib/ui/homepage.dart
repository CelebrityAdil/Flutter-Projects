...
import 'package:weather_app/widget/constraint.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY =
      '98c45d5d719940e7a4c140934251810'; //Paste Your API Here
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      resizeToAvoidBottomInset: true, // ✅ Allow UI to move up with keyboard
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // ✅ this part remains same (hourly forecast section)
              Container(
